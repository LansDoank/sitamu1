        ...
        <section id="receptionist-login"
            ...
            <div id="receptionist-form"
                ...
                <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                    ...
                    <h5 class="text-klipaa font-semibold">TamuDesa</h5>
                </a>
                <div
                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        <div class="">
                            ...
                            <p class="text-sm font-light text-gray-500 dark:text-gray-400">Silahkan masukan username dan
                                password anda</p>
                        </div>
                        ...
                        <form class="space-y-4 md:space-y-6" action="/login" method="POST">
                            ...
                            <div>
                                ...
                                <input type="text" name="username" id="username"
                                    class="bg-white text-sm border border-gray-300 text-gray-900 rounded-xl focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            ...
                            <button type="submit"
                                class="w-full text-white bg-klipaa focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-xl text-sm px-5 py-2.5 text-center hover:brightness-90">Masuk</button>
